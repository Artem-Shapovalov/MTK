...
static color_set get_colors(mock_lcd::palette colors)
{
  ...
  switch (colors)
  {
  case mock_lcd::palette::lcd_green:
    set = lcd_green;
    break;

  case mock_lcd::palette::lcd_yellow:
    set = lcd_yellow;
    break;

  case mock_lcd::palette::oled_blue:
    set = oled_blue;
    break;

  case mock_lcd::palette::oled_white:
    set = oled_white;
    break;

  case mock_lcd::palette::oled_green:
    set = oled_green;
    break;

  case mock_lcd::palette::plain_bw:
    set = plain_bw;
    break;
...
mtk::display& mock_lcd::init()
{
  return *this;
}

mtk::display& mock_lcd::deinit()
{
  return *this;
}
